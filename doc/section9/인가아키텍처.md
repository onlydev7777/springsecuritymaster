...
![커스텀 변경 된 구조.png](커스텀 변경 된 구조.png)
...
![@PreAuthorize.png](@PreAuthorize.png)

***
#### 메서드 권한 부여 초기화 과정

![메서드 권한 부여 초기화 과정.png](메서드 권한 부여 초기화 과정.png)
...
![초기화 과정 구성도.png](초기화 과정 구성도.png)

**- AbstractAutoProxyCreator**
- 메서드 보안 설정 메서드를 찾아 프록시 객체를 생성한다.
![AbstractAutoProxyCreator.png](AbstractAutoProxyCreator.png)

***
#### @PreAuthorize 처리 구조 이해

![@PreAuthorize 처리 구조 이해.png](@PreAuthorize 처리 구조 이해.png)
...
![AuthorizationManagerBeforeMethodInterceptor-DEBUG.png](AuthorizationManagerBeforeMethodInterceptor-DEBUG.png)

***

#### @PostAuthorize 처리 구조 이해

![@PostAuthorize 처리 구조 이해.png](@PostAuthorize 처리 구조 이해.png)
...
- AnnotationAwareAspectJAutoProxyCreator
  ...
  <br><br>
  ![AnnotationAwareAspectJAutoProxyCreator.png](AnnotationAwareAspectJAutoProxyCreator.png)
